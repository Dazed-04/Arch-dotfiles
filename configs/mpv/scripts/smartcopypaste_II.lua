...
local o = {
	...
	linux_copy = "wl-copy -silent -selection clipboard -in", --copy command that will be used in Linux. OR write a different command
	linux_paste = "wl-paste -selection clipboard -o", --paste command that will be used in Linux. OR write a different command
